...
/**
 * Run the list-managed-oci-containers.py script and return parsed results.
 * Reuses the same logic as the Installations route.
 */
async function listManagedContainers(
  pm: PersistenceManager,
  veContext: import("@src/backend-types.mjs").IVEContext,
